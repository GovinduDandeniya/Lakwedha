/// Province -> District -> Cities hierarchy.
const Map<String, Map<String, List<String>>> sriLankaLocationHierarchy = {
  'Western': {
    'Colombo': [
...
/// Backward-compatible province -> district map.
final Map<String, List<String>> sriLankaLocations = {
  for (final provinceEntry in sriLankaLocationHierarchy.entries)
    provinceEntry.key: provinceEntry.value.keys.toList(),
};

List<String> getProvinces() => sriLankaLocationHierarchy.keys.toList();

List<String> getDistricts(String province) =>
    sriLankaLocationHierarchy[province]?.keys.toList() ?? [];

List<String> getCities(String province, String district) =>
    sriLankaLocationHierarchy[province]?[district] ?? [];
