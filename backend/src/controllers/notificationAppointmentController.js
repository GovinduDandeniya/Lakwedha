 ...
 * Books appointments and sends SMS/Email confirmations.
 */
...
const bookAppointment = async (req, res) => {
    try {
        ...
        const appointment = saveAppointment({
            patientName, doctorName, hospitalName, date, time, phone, email, status: 'Confirmed'
        });
        ...
        return res.status(500).json({ success: false, message: 'Internal server error while booking appointment' });
    }
};
